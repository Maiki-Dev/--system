...
const ACTIVE_SUPABASE_KEY = SUPABASE_PUBLIC_KEY || SUPABASE_ANON_KEY
...
export function createClientInstance(): SupabaseClient<Database> {
  ...
  if (SUPABASE_ANON_KEY?.startsWith('sb_secret_')) {
    console.warn('⚠️ VITE_SUPABASE_ANON_KEY-д service role key ашиглагдаж байна. Browser auth-д VITE_SUPABASE_PUBLIC_KEY эсвэл publishable anon key ашиглана уу.')
  }
